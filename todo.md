# Aufgabenliste – neue externe Landingpages

- [x] GitHub-Connector prüfen und den Zugriff für Veröffentlichung und Pages-Bereitstellung wiederherstellen.
- [x] Bestehendes Newsletter-Repository unangetastet lassen und nur das neue Projekt verwenden.
- [x] Neues separates GitHub-Repository für Newsletter- und Leseproben-Landingpage anlegen.
- [x] Markenassets sicher einbinden: Hero, Newsletter-Illustration, Leseproben-Illustration, Bildmarke und PDF-Vorschau.
- [x] Route `/newsletter` als eigenständige, markenkonforme Newsletter-Landingpage bauen.
